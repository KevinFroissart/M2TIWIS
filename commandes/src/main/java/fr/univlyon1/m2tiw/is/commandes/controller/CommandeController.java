...
public class CommandeController implements Startable {
	...
	public Object process(String commande, Map<String, Object> parametres) throws SQLException, NotFoundException, EmptyCommandeException {
		switch (commande) {
			...
			case "savecommande":
				return saveCommande((Commande) parametres.get("commande"));
			default:
				return null;
		}
	}
	...
	public Commande saveCommande(Commande commande) throws SQLException {
		LOG.info("Méthode appelée: saveCommande, avec paramètre: {}", commande);
		return gestionCommandeService.saveCommande(commande);
	}

	public void deleteCommande(long commandeId) throws SQLException {
		LOG.info("Méthode appelée: saveCommande, avec paramètre: {}", commandeId);
		gestionCommandeService.deleteCommande(commandeId);
	}
