...
public class VoitureController implements Startable {
	...
	public Object process(String commande, Map<String, Object> parametres) throws SQLException, NotFoundException, InvalidConfigurationException {
		switch (commande) {
			...
			case "sauvervoiture":
				...
				return null;
			case "savevoiture":
				return saveVoiture((Voiture) parametres.get("voiture"), (Long) parametres.get("commandeId"));
			...
			case "supprimervoiture":
				...
				return null;
			case "deletevoiture":
				deleteVoiture((Voiture) parametres.get("voiture"));
				return null;
			default:
				return null;
		}
	...
	public Voiture saveVoiture(Voiture voiture, long commandeId) throws SQLException {
		LOG.info("Méthode appelée: sauverVoiture, avec comme paramètres(s): {}, {}", voiture, commandeId);
		return voitureService.saveVoiture(voiture, commandeId);
	}
	...
	public void deleteVoiture(Voiture voiture) throws SQLException, NotFoundException {
		LOG.info("Méthode appelée: deleteVoiture, avec comme paramètre(s): {}", voiture);
