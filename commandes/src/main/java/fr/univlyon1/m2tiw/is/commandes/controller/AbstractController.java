...
public abstract class AbstractController implements Controller, Startable {
	...
	@Override
	public abstract Object process(String commande, Map<String, Object> parametres) throws SQLException, NotFoundException, EmptyCommandeException, InvalidConfigurationException;
	@Override
	public void start() {
